...
func (s *UnimplementedRemoveLogo) CreateRemoveLogoTask(ctx context.Context, req *CreateRemoveLogoTaskRequest, rsp *CreateRemoveLogoTaskResponse) error {
	return errors.New("rpc CreateRemoveLogoTask of service RemoveLogo is not implemented")
}
func (s *UnimplementedRemoveLogo) DescribeRemoveLogoTaskData(ctx context.Context, req *DescribeRemoveLogoTaskDataRequest, rsp *DescribeRemoveLogoTaskDataResponse) error {
	return errors.New("rpc DescribeRemoveLogoTaskData of service RemoveLogo is not implemented")
}

type UnimplementedRemoveCaption struct{}

func (s *UnimplementedRemoveCaption) CreateRemoveCaptionTask(ctx context.Context, req *CreateRemoveCaptionTaskRequest, rsp *CreateRemoveCaptionTaskResponse) error {
	return errors.New("rpc CreateRemoveCaptionTask of service RemoveCaption is not implemented")
}
func (s *UnimplementedRemoveCaption) DescribeRemoveCaptionTaskData(ctx context.Context, req *DescribeRemoveCaptionTaskDataRequest, rsp *DescribeRemoveCaptionTaskDataResponse) error {
	return errors.New("rpc DescribeRemoveCaptionTaskData of service RemoveCaption is not implemented")
}
