...
func (s *UnimplementedAiTagAnalyse) DescribeL1L2Labels(ctx context.Context, req *CommonRequest, rsp *DescribeL1L2LabelsResponse) error {
	return errors.New("rpc DescribeL1L2Labels of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) CreateTag(ctx context.Context, req *CreateTagRequest, rsp *CreateTagResponse) error {
	return errors.New("rpc CreateTag of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) ImportTag(ctx context.Context, req *ImportTagRequest, rsp *ImportTagResponse) error {
	return errors.New("rpc ImportTag of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) DeleteTag(ctx context.Context, req *DeleteTagRequest, rsp *DeleteTagResponse) error {
	return errors.New("rpc DeleteTag of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) ModifyTag(ctx context.Context, req *ModifyTagRequest, rsp *ModifyTagResponse) error {
	return errors.New("rpc ModifyTag of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) DescribeTags(ctx context.Context, req *DescribeTagsRequest, rsp *DescribeTagsResponse) error {
	return errors.New("rpc DescribeTags of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) CreateTagAnalysisTask(ctx context.Context, req *CreateTagAnalysisTaskRequest, rsp *CreateTagAnalysisTaskResponse) error {
	return errors.New("rpc CreateTagAnalysisTask of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) DescribeTagAnalysisTaskData(ctx context.Context, req *DescribeTagAnalysisTaskDataRequest, rsp *DescribeTagAnalysisTaskDataResponse) error {
	return errors.New("rpc DescribeTagAnalysisTaskData of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) DescribeTagFiles(ctx context.Context, req *DescribeTagFilesRequest, rsp *DescribeTagFilesResponse) error {
	return errors.New("rpc DescribeTagFiles of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) DeleteTagFiles(ctx context.Context, req *DeleteTagFilesRequest, rsp *DeleteTagFilesResponse) error {
	return errors.New("rpc DeleteTagFiles of service AiTagAnalyse is not implemented")
}
func (s *UnimplementedAiTagAnalyse) GetTagFileUrl(ctx context.Context, req *TagFileUrlRequest, rsp *TagFileUrlResponse) error {
	return errors.New("rpc GetTagFileUrl of service AiTagAnalyse is not implemented")
}
