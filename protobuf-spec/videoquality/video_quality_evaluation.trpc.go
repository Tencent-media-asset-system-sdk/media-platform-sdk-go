...
func (s *UnimplementedVideoQualityEvaluation) CreateVideoQualityEvaluationTask(ctx context.Context, req *CreateVideoQualityEvaluationTaskRequest, rsp *CreateVideoQualityEvaluationTaskResponse) error {
	return errors.New("rpc CreateVideoQualityEvaluationTask of service VideoQualityEvaluation is not implemented")
}
func (s *UnimplementedVideoQualityEvaluation) DescribeVideoQualityEvaluationTaskData(ctx context.Context, req *DescribeVideoQualityEvaluationTaskDataRequest, rsp *DescribeVideoQualityEvaluationTaskDataResponse) error {
	return errors.New("rpc DescribeVideoQualityEvaluationTaskData of service VideoQualityEvaluation is not implemented")
}
func (s *UnimplementedVideoQualityEvaluation) DescribeLiveVideoQualityEvaluationTaskData(ctx context.Context, req *DescribeVideoQualityEvaluationTaskDataRequest, rsp *DescribeLiveVideoQualityEvaluationTaskDataResponse) error {
	return errors.New("rpc DescribeLiveVideoQualityEvaluationTaskData of service VideoQualityEvaluation is not implemented")
}
func (s *UnimplementedVideoQualityEvaluation) DescribeVideoQualityLimitList(ctx context.Context, req *DescribeVideoQualityLimitListRequest, rsp *DescribeVideoQualityLimitListResponse) error {
	return errors.New("rpc DescribeVideoQualityLimitList of service VideoQualityEvaluation is not implemented")
}
